...
import { 
  ...
  Sparkles, ArrowRight, Zap, Code2, MessageCircle 
} from "lucide-react";
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await registerUser(callApi, { name, email, password });
      if (response.success) {
        login(response.data.token, response.data.user);
        navigate("/");
      } else {
        setError(response.errMessage || "Registration failed");
      }
    } catch (err: any) {
      console.error(err);
      setError(
        ...
        <div className="relative z-10 w-full max-w-lg">
          ...
          <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="text-center pt-8 pb-4 px-8">
              ...
              <p className="text-gray-400 mt-2">Create your account and explore possibilities</p>
            </div>
            ...
            <div className="px-8 pb-8">
                  ...
                  {password && (
                    <div className="mt-2 space-y-2">
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        {password.length >= 6 && password.length < 10 && "Getting stronger!"}
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-400 text-sm">
                  ...
                  <Link to="/login" className="text-purple-400 hover:text-pink-400 font-semibold transition-all duration-300 inline-flex items-center gap-1 group">
                    Sign in
